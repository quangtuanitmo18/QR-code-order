...
export default function Layout({
  ...
  return (
    <div className="flex w-full flex-col bg-muted/20 sm:flex-row">
      <NavLinks />
      <div className="flex flex-1 flex-col sm:gap-4 sm:py-4">
        <header className="sticky top-0 z-30 flex h-14 items-center gap-2 border-b border-border/50 bg-background/80 px-3 backdrop-blur-xl sm:static sm:h-auto sm:gap-4 sm:border-0 sm:bg-transparent sm:px-6">
          <MobileNavLinks />
