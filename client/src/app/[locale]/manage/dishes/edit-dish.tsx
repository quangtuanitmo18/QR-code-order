...
export default function EditDish({
  ...
  const getEditDishQuery = useGetDishQuery({ id: id as number, enabled: Boolean(id) })
  ...
  useEffect(() => {
    if (getEditDishQuery.data) {
      const { name, image, description, price, category, status } = getEditDishQuery.data.payload.data
      form.reset({
        name,
