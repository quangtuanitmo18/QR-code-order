...
export const CreateEventBody = BaseEventSchema.extend({
  ...
  .superRefine((data, ctx) => {
    ...
    // Note: work_shift validation will be done in frontend after fetching CalendarType
...
export type GetEventDatesWithCountsQueryParamsType = z.TypeOf<
  typeof GetEventDatesWithCountsQueryParams
>
