...
describe('AutoPagination', () => {
  describe('Button mode (isLink=false)', () => {
    it('renders correct number of page buttons', () => {
      render(
        <AutoPagination page={1} pageSize={5} isLink={false} />
      )
    ...
    it('calls onClick with correct page when a page button is clicked', () => {
      const onClick = vi.fn()
      render(
        <AutoPagination page={1} pageSize={5} isLink={false} onClick={onClick} />
      )
    ...
    it('disables Next button on last page', () => {
      render(
        <AutoPagination page={5} pageSize={5} isLink={false} />
      )
    ...
    it('calls onClick(page-1) when Previous is clicked on page 2', () => {
      const onClick = vi.fn()
      render(
        <AutoPagination page={2} pageSize={5} isLink={false} onClick={onClick} />
      )
    ...
    it('shows ellipsis for large page counts', () => {
      const { container } = render(
        <AutoPagination page={10} pageSize={20} isLink={false} />
      )
